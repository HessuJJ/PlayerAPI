...
# Router that defines to endpoints URL-root "/players" and groups them to tag "players"
router = APIRouter(prefix="/players", tags=["Players"])

#Router get that calls crud function that gets all players from database.
...
#Router post that calls crud function that creates new player to database.
